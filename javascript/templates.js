...
buf.push("<div class=\"ui main container\"><table class=\"bank ui celled unstackable table\"><thead style=\"text-align:center\"><tr><th>집행 날짜</th><th>부서</th><th>구분</th><th>상세 내역</th><th>No</th><th>수입 금액</th><th>지출 금액</th><th>남은 금액</th><th>비고</th><th>정보</th><th>이체</th><th>삭제</th></tr></thead><tfoot><tr style=\"text-align:center\"><th colspan=\"3\">은행 금액: " + (jade.escape((jade_interp = part2.bankMoney) == null ? '' : jade_interp)) + "</th><th colspan=\"2\">은행 합계: " + (jade.escape((jade_interp = totalBank) == null ? '' : jade_interp)) + "</th><th colspan=\"2\">총 지출액: " + (jade.escape((jade_interp = part2.spendSum) == null ? '' : jade_interp)) + "</th><th colspan=\"2\">남은 금액: " + (jade.escape((jade_interp = part2.curMoney) == null ? '' : jade_interp)) + "</th><th colspan=\"3\">금액 합계: " + (jade.escape((jade_interp = totalCur) == null ? '' : jade_interp)) + "</th></tr></tfoot>");
...
buf.push("<input type=\"hidden\"" + (jade.attr("name", "RowKey[" + (part2.name) + "][" + (index) + "]", true, false)) + (jade.attr("value", "" + (item.RowKey) + "", true, false)) + "/><input type=\"hidden\"" + (jade.attr("name", "PartitionKey[" + (part2.name) + "][" + (index) + "]", true, false)) + (jade.attr("value", "" + (item.PartitionKey) + "", true, false)) + "/><input type=\"hidden\"" + (jade.attr("name", "deleteRow[" + (part2.name) + "][" + (index) + "]", true, false)) + " value=\"false\"" + (jade.cls(["delete" + (part2.name) + "" + (index) + ""], [true])) + "/><tr onclick=\"SelectRow()\" href=\"#\" style=\"text-align:center\"" + (jade.cls(["tr" + (part2.name) + "" + (index) + ""], [true])) + "><td>" + (jade.escape((jade_interp = item.year) == null ? '' : jade_interp)) + "." + (jade.escape((jade_interp = item.month) == null ? '' : jade_interp)) + "." + (jade.escape((jade_interp = item.day) == null ? '' : jade_interp)) + "</td><td>" + (jade.escape((jade_interp = item.section) == null ? '' : jade_interp)) + "</td><td style=\"max-width:120px\">" + (jade.escape((jade_interp = item.content||'') == null ? '' : jade_interp)) + " </td><td style=\"max-width:20px\">" + (jade.escape((jade_interp = item.receiptNo || '') == null ? '' : jade_interp)) + "</td><td style=\"max-width:70px\">" + (jade.escape((jade_interp = item.gain || '') == null ? '' : jade_interp)) + "</td><td style=\"max-width:70px\">" + (jade.escape((jade_interp = item.spend || '') == null ? '' : jade_interp)) + " </td><td>" + (jade.escape((jade_interp = item.curMoney || '') == null ? '' : jade_interp)) + "</td><td style=\"max-width:70px\">" + (jade.escape((jade_interp = item.detail || item.bankReceive || '') == null ? '' : jade_interp)) + "</td><td colspan=\"3\"><i" + (jade.attr("data-content", "계좌번호: " + (item.bankNumber||'') + "(" + (item.bankName||'') + ")", true, false)) + " class=\"ui circular info icon\"></i></td></tr>");
    }
