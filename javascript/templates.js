...
buf.push("<tr><td>" + (jade.escape((jade_interp = item.month) == null ? '' : jade_interp)) + "." + (jade.escape((jade_interp = item.day) == null ? '' : jade_interp)) + "</td><td>" + (jade.escape((jade_interp = item.section) == null ? '' : jade_interp)) + "</td><td>" + (jade.escape((jade_interp = item.content) == null ? '' : jade_interp)) + "</td><td style=\"max-width:120px; width:120px;\">" + (jade.escape((jade_interp = item.receiptNo || '') == null ? '' : jade_interp)) + "</td><td style=\"font-size:6pt\">" + (jade.escape((jade_interp = item.gain || '') == null ? '' : jade_interp)) + "</td><td><i style=\"font-size:6pt\"" + (jade.attr("data-content", "계좌번호: " + (item.bankNumber||'') + "(" + (item.bankName||'') + ")", true, false)) + " class=\"label info\">" + (jade.escape((jade_interp = item.spend || '') == null ? '' : jade_interp)) + "</i></td><td><i style=\"font-size:6pt\"" + (jade.attr("data-content", "계좌번호: " + (item.bankNumber||'') + "(" + (item.bankName||'') + ")", true, false)) + " class=\"label info\">" + (jade.escape((jade_interp = item.curMoney || '') == null ? '' : jade_interp)) + "</i></td></tr>");
    }
